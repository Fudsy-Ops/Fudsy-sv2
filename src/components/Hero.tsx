...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FCFAF0] via-[#F7F2D7] to-[#F1EAC2] relative overflow-hidden px-4 sm:px-6 md:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(242,105,0,0.08) 0%, transparent 70%)",
